...
protected:
    ...
    wxPoint GetCentre() const { return wxPoint(m_pos.x + m_size.x / 2 - 1, m_pos.y + m_size.y / 2 - 1); }
...
DnDShape *DnDShapeDialog::GetShape() const {
    switch (m_shapeKind) {
        ...
        case DnDShape::None:
            return nullptr;
        case DnDShape::Triangle:
            return new DnDTriangularShape(m_pos, m_size, m_col);
        case DnDShape::Rectangle:
            return new DnDRectangularShape(m_pos, m_size, m_col);
        case DnDShape::Ellipse:
            return new DnDEllipticShape(m_pos, m_size, m_col);
    }
}
